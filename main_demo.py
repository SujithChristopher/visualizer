...
if os.path.exists(os.path.join(os.getcwd(), 'demo')):
    shutil.rmtree(os.path.join(os.getcwd(), 'demo'))
    os.mkdir(os.path.join(os.getcwd(), 'demo'))
else:
    os.mkdir(os.path.join(os.getcwd(), 'demo'))
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data_pth = os.path.join(os.getcwd(), 'demo')
