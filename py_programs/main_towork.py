...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.offset_trigger = [False, False, False, False]
        
        self.mobbo_offset = {'m1':[0, 0, 0, 0], 'm2':[0, 0, 0, 0], 'm3':[0, 0, 0, 0], 'm4':[0, 0, 0, 0]}
        
        # importing calibration excel sheet for loadcells
        self.calib_df = pl.read_csv(os.path.join(os.getcwd(), 'calibration','calib.csv'))
        self.calib_finder = {'m1':[1, 2, 3, 4], 'm2':[5, 6, 7, 8], 'm3':[9, 10, 11, 12], 'm4':[13, 14, 15, 16]}      
        ...
        self.blue_pen = pg.mkPen(color=(0, 0, 255), width=3)
        ...
        self.mobbo_csv_trigger = [False, False, False, False]
        self.mobbo_csv_writer = [None, None, None, None]
    ...
    def mobbo_update(self, data):
        ...
        if not self.offset_trigger[self.active_mobbo - 1]:
            ...
            self.mobbo_offset['m'+str(self.active_mobbo)][0] = (adc1 - self.calib_df['lc_offset'][self.mobbo_select[0]])/self.calib_df['lc_scalar'][self.mobbo_select[0]]
            self.mobbo_offset['m'+str(self.active_mobbo)][1] = (adc2 - self.calib_df['lc_offset'][self.mobbo_select[1]])/self.calib_df['lc_scalar'][self.mobbo_select[1]]
            self.mobbo_offset['m'+str(self.active_mobbo)][2] = (adc3 - self.calib_df['lc_offset'][self.mobbo_select[2]])/self.calib_df['lc_scalar'][self.mobbo_select[2]]
            self.mobbo_offset['m'+str(self.active_mobbo)][3] = (adc4 - self.calib_df['lc_offset'][self.mobbo_select[3]])/self.calib_df['lc_scalar'][self.mobbo_select[3]]
            self.offset_trigger[self.active_mobbo - 1] = True
            
        l1 = (adc1 - self.calib_df['lc_offset'][self.mobbo_select[0]])/self.calib_df['lc_scalar'][self.mobbo_select[0]] - self.mobbo_offset['m'+str(self.active_mobbo)][0]
        l2 = (adc2 - self.calib_df['lc_offset'][self.mobbo_select[1]])/self.calib_df['lc_scalar'][self.mobbo_select[1]] - self.mobbo_offset['m'+str(self.active_mobbo)][1]
        l3 = (adc3 - self.calib_df['lc_offset'][self.mobbo_select[2]])/self.calib_df['lc_scalar'][self.mobbo_select[2]] - self.mobbo_offset['m'+str(self.active_mobbo)][2]
        l4 = (adc4 - self.calib_df['lc_offset'][self.mobbo_select[3]])/self.calib_df['lc_scalar'][self.mobbo_select[3]] - self.mobbo_offset['m'+str(self.active_mobbo)][3]
